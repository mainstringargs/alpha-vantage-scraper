...
public class OBV extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private OBV(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<OBV> {
        ...
        @Override
        OBV resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
