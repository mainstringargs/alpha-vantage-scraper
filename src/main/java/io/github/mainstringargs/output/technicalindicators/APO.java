...
public class APO extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private APO(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<APO> {
        ...
        @Override
        APO resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
