...
public class CCI extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private CCI(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<CCI> {
        ...
        @Override
        CCI resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
