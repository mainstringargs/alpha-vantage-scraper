...
public class MOM extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private MOM(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<MOM> {
        ...
        @Override
        MOM resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
