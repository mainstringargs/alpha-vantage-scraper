...
public class ADX extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private ADX(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<ADX> {
        ...
        @Override
        ADX resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
