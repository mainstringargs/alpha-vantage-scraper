...
public class AD extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private AD(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<AD> {
        ...
        @Override
        AD resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
