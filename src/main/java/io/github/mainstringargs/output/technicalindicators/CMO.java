...
public class CMO extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private CMO(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<CMO> {
        ...
        @Override
        CMO resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
