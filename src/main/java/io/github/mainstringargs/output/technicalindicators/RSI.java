...
public class RSI extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private RSI(final Map<String, String> metaData, final List<IndicatorData> indicatorData) {
    ...
    private static class Parser extends TechnicalIndicatorParser<RSI> {
        ...
        @Override
        RSI resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData)
