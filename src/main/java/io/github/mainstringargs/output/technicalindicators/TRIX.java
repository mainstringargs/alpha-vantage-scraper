...
/**
 * Representation of the 1-day rate of change of a triple smooth exponential moving average (TRIX)
 * response from api.
 *
...
public class TRIX extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private TRIX(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<TRIX> {
        ...
        @Override
        TRIX resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
