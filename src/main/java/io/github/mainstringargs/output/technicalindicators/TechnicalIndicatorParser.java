...
/**
 * Since the format for the technical indicator responses differ slightly but on the whole have the
 * same structure the {@code TechnicalIndicatorParser} extracts the similarity of the parsing to
 * this class.
 *
 * @see JsonParser
...
public abstract class TechnicalIndicatorParser<Data> extends JsonParser<Data> {
    ...
    /**
     * Gets the key for the indicators, this differs for each response type, i.e MACD, EMA etc. This
     * is used by the resolve method below.
     *
    ...
    /**
     * Helper method for resolving local date time. If the key to the data object doesn´t specify
     * hours and minutes it returns the hour at beginning of that day.
     *
     * @param key the key to the data object, i.e: "2017-12-01 11:15" or "2017-12-01" depending on
     *        interval
    ...
    protected Data resolve(JsonObject rootObject) {
        ...
        try {
            ...
            Map<String, Map<String, String>> indicatorData =
                            GSON.fromJson(rootObject.get(getIndicatorKey()), dataType);
