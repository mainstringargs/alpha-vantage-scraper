...
/**
 * Representation of the Hilbert transform, instantaneous trendline (HT_TRENDLINE) response from
 * api.
 *
...
public class HT_TRENDLINE extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private HT_TRENDLINE(final Map<String, String> metaData, final List<IndicatorData> indicators) {
