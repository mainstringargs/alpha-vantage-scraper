...
public class SAR extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private SAR(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<SAR> {
        ...
        @Override
        SAR resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
