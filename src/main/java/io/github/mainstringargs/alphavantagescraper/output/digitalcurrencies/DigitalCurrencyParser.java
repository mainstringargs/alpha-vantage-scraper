package io.github.mainstringargs.alphavantagescraper.output.digitalcurrencies;
 ...
 * have the same structure the {@code DigitalCurrencyParser} extracts the similarity of the parsing
 * to this class.
 *
 * @see JsonParser
...
abstract class DigitalCurrencyParser<Data> extends JsonParser<Data> {
    ...
    /**
     * Gets the key for the digital currency data, this differs for each response type, i.e
    ...
    public Data resolve(JsonObject rootObject) {
        ...
        try {
            ...
            Map<String, Map<String, String>> digitalCurrencyData =
                            GSON.fromJson(rootObject.get(getDigitalCurrencyDataKey()), dataType);
