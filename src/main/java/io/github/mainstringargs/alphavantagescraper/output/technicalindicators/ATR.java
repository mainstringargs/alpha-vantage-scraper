...
public class ATR extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private ATR(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<ATR> {
        ...
        @Override
        ATR resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
