...
public class DEMA extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private DEMA(final Map<String, String> metaData, final List<IndicatorData> indicatorData) {
    ...
    private static class Parser extends TechnicalIndicatorParser<DEMA> {
        ...
        @Override
        DEMA resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData)
