...
public class MFI extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private MFI(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<MFI> {
        ...
        @Override
        MFI resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
