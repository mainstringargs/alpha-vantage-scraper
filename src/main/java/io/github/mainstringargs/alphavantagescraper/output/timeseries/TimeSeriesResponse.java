...
/**
 * Response from time series call. Each specific response, i.e IntraDay, Daily, etc, extends this
 * class. This class simply acts as a container of metadata and stockdata.
 */
