...
public class DX extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private DX(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<DX> {
        ...
        @Override
        DX resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
