...
public class PPO extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private PPO(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<PPO> {
        ...
        @Override
        PPO resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
