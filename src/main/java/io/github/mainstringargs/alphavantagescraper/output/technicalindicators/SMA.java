...
public class SMA extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private SMA(final Map<String, String> metaData, final List<IndicatorData> indicatorData) {
    ...
    private static class Parser extends TechnicalIndicatorParser<SMA> {
        ...
        @Override
        SMA resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
