...
public class NATR extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private NATR(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<NATR> {
        ...
        @Override
        NATR resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
