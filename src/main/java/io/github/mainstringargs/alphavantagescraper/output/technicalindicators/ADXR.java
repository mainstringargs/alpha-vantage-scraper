...
public class ADXR extends TechnicalIndicatorResponse<IndicatorData> {
    ...
    private ADXR(final Map<String, String> metaData, final List<IndicatorData> indicators) {
    ...
    private static class Parser extends TechnicalIndicatorParser<ADXR> {
        ...
        @Override
        ADXR resolve(Map<String, String> metaData, Map<String, Map<String, String>> indicatorData) {
