...
import io.github.mainstringargs.output.sectorperformances.Sectors;
...
public class SectorPerformancesTest {
    ...
    public void sector() {
        ...
        assertThat(metaData.get("Information"),
                        is(equalTo("US Sector Performance (realtime & historical)")));
