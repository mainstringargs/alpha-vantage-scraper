...
import io.github.mainstringargs.alphavantagescraper.DigitalCurrencies;
...
import io.github.mainstringargs.alphavantagescraper.output.digitalcurrencies.data.DigitalCurrencyData;
import io.github.mainstringargs.alphavantagescraper.output.digitalcurrencies.data.SimpelDigitalCurrencyData;
...
public class DigitalCurrenciesTest {
    ...
    public void intraDay() {
        ...
        assertThat(metaData.get("1. Information"),
                        is(equalTo("Intraday Prices and Volumes for Digital Currency")));
    ...
    public void daily() {
        ...
        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1. Information"),
                        is(equalTo("Daily Prices and Volumes for Digital Currency")));
    ...
    public void weekly() {
        ...
        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1. Information"),
                        is(equalTo("Weekly Prices and Volumes for Digital Currency")));
        assertThat(metaData.get("2. Digital Currency Code"), is(equalTo("BTC")));
        assertThat(metaData.get("3. Digital Currency Name"), is(equalTo("Bitcoin")));
        assertThat(metaData.get("4. Market Code"), is(equalTo("CNY")));
        assertThat(metaData.get("5. Market Name"), is(equalTo("Chinese Yuan")));
    ...
    public void monthly() {
        ...
        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1. Information"),
                        is(equalTo("Monthly Prices and Volumes for Digital Currency")));
        assertThat(metaData.get("2. Digital Currency Code"), is(equalTo("BTC")));
        assertThat(metaData.get("3. Digital Currency Name"), is(equalTo("Bitcoin")));
        assertThat(metaData.get("4. Market Code"), is(equalTo("CNY")));
        assertThat(metaData.get("5. Market Name"), is(equalTo("Chinese Yuan")));
