...
import io.github.mainstringargs.alphavantagescraper.output.technicalindicators.data.AROONData;
import io.github.mainstringargs.alphavantagescraper.output.technicalindicators.data.BBANDSData;
import io.github.mainstringargs.alphavantagescraper.output.technicalindicators.data.HT_PHASORData;
import io.github.mainstringargs.alphavantagescraper.output.technicalindicators.data.HT_SINEData;
...
import io.github.mainstringargs.alphavantagescraper.output.technicalindicators.data.STOCHDataFast;
...
public class TechnicalIndicatorsTest {
    ...
    public void dema() {
        ...
        DEMA response = technicalIndicators.dema("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);

        Map<String, String> metaData = response.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("Double Exponential Moving Average (DEMA)")));
    ...
    public void ema() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        EMA resp = technicalIndicators.ema("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void kama() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        KAMA resp = technicalIndicators.kama("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);

        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("Kaufman Adaptive Moving Average (KAMA)")));
    ...
    public void macd() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "            \"MACD\": \"-0.3599\"\n" + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MACD resp = technicalIndicators.macd("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE, FastPeriod.of(10), SlowPeriod.of(26), null);

        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("Moving Average Convergence/Divergence (MACD)")));
        assertThat(metaData.get("3: Last Refreshed"), is(equalTo("2017-12-14 16:00:00")));
        assertThat(metaData.get("4: Interval"), is(equalTo("15min")));
    ...
    public void macdext() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MACDEXT resp = technicalIndicators.macdext("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE, null, null, null, null, null, null);

        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("MACD with Controllable MA Type (MACDEXT)")));
        assertThat(metaData.get("3: Last Refreshed"), is(equalTo("2017-12-14 16:00:00")));
        assertThat(metaData.get("4: Interval"), is(equalTo("15min")));
    ...
    public void mama() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MAMA resp = technicalIndicators.mama("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10), null,
                        null, null);
        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("MESA Adaptive Moving Average (MAMA)")));
        assertThat(metaData.get("3: Last Refreshed"), is(equalTo("2017-12-14 16:00:00")));
        assertThat(metaData.get("4: Interval"), is(equalTo("15min")));
    ...
    public void rsi() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        RSI resp = technicalIndicators.rsi("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
        Map<String, String> metaData = resp.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
    ...
    public void sma() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        SMA resp = technicalIndicators.sma("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void stoch() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        STOCH resp = technicalIndicators.stoch("DUMMY", Interval.FIFTEEN_MIN, null, null, null,
                        null, null);
    ...
    public void stochrsi() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "            \"FastD\": \"81.4649\"\n" + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        STOCHRSI resp = technicalIndicators.stochrsi("DUMMY", Interval.FIFTEEN_MIN,
                        TimePeriod.of(10), SeriesType.CLOSE, null, null, null);
    ...
    public void t3() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        T3 resp = technicalIndicators.t3("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void tema() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "            \"TEMA\": \"82.6005\"\n" + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        TEMA response = technicalIndicators.tema("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);

        Map<String, String> metaData = response.getMetaData();
        assertThat(metaData.get("1: Symbol"), is(equalTo("DUMMY")));
        assertThat(metaData.get("2: Indicator"),
                        is(equalTo("Triple Exponential Moving Average (TEMA)")));
        assertThat(metaData.get("3: Last Refreshed"), is(equalTo("2017-12-01 16:00:00")));
        assertThat(metaData.get("4: Interval"), is(equalTo("15min")));
        assertThat(metaData.get("5: Time Period"), is(equalTo("10")));
        assertThat(metaData.get("6: Series Type"), is(equalTo("close")));
    ...
    public void trima() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        TRIMA resp = technicalIndicators.trima("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void wma() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        WMA response = technicalIndicators.wma("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void apo() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        APO response = technicalIndicators.apo("DUMMY", Interval.FIFTEEN_MIN, SeriesType.CLOSE,
                        null, null, null);
    ...
    public void ppo() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        PPO response = technicalIndicators.ppo("DUMMY", Interval.FIFTEEN_MIN, SeriesType.CLOSE,
                        null, null, null);
    ...
    public void mom() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MOM response = technicalIndicators.mom("DUMMY", Interval.FIFTEEN_MIN, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void cmo() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        CMO response = technicalIndicators.cmo("DUMMY", Interval.DAILY, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void roc() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        ROC response = technicalIndicators.roc("DUMMY", Interval.WEEKLY, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void rocr() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "            \"ROCR\": \"0.9893\"\n" + "        }\n" + "    }\n" + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        ROCR response = technicalIndicators.rocr("DUMMY", Interval.DAILY, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void aroonosc() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        AROONOSC response = technicalIndicators.aroonosc("DUMMY", Interval.THIRTY_MIN,
                        TimePeriod.of(10));
    ...
    public void trix() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        TRIX response = technicalIndicators.trix("DUMMY", Interval.DAILY, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void ultosc() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        ULTOSC response =
                        technicalIndicators.ultosc("DUMMY", Interval.THIRTY_MIN, null, null, null);
    ...
    public void minus_di() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MINUS_DI response =
                        technicalIndicators.minus_di("DUMMY", Interval.WEEKLY, TimePeriod.of(10));
    ...
    public void plus_di() {
        String json = "" + "{\n" + "    \"Meta Data\": {\n" + "        \"1: Symbol\": \"DUMMY\",\n"
                        ...
                        + "}";
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        PLUS_DI response = technicalIndicators.plus_di("DUMMY", Interval.THIRTY_MIN,
                        TimePeriod.of(10));
    ...
    public void minus_dm() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MINUS_DM response =
                        technicalIndicators.minus_dm("DUMMY", Interval.DAILY, TimePeriod.of(10));
    ...
    public void bbands() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        BBANDS response = technicalIndicators.bbands("DUMMY", Interval.WEEKLY, TimePeriod.of(5),
                        SeriesType.CLOSE, null, null, null);
    ...
    public void midpoint() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MIDPOINT response = technicalIndicators.midpoint("DUMMY", Interval.DAILY, TimePeriod.of(10),
                        SeriesType.CLOSE);
    ...
    public void midprice() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        MIDPRICE response = technicalIndicators.midprice("DUMMY", Interval.THIRTY_MIN,
                        TimePeriod.of(10));
    ...
    public void ht_trendline() {
        ...
        HT_TRENDLINE response =
                        technicalIndicators.ht_trendline("DUMMY", Interval.DAILY, SeriesType.CLOSE);
    ...
    public void ht_sine() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        HT_SINE response =
                        technicalIndicators.ht_sine("DUMMY", Interval.THIRTY_MIN, SeriesType.CLOSE);
    ...
    public void ht_trendmode() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        HT_TRENDMODE response = technicalIndicators.ht_trendmode("DUMMY", Interval.WEEKLY,
                        SeriesType.CLOSE);
    ...
    public void ht_dcperiod() {
        ...
        HT_DCPERIOD response =
                        technicalIndicators.ht_dcperiod("DUMMY", Interval.DAILY, SeriesType.CLOSE);
    ...
    public void ht_dcphase() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        HT_DCPHASE response = technicalIndicators.ht_dcphase("DUMMY", Interval.THIRTY_MIN,
                        SeriesType.CLOSE);
    ...
    public void ht_phasor() {
        ...
        technicalIndicators = new TechnicalIndicators(apiParameters -> json);
        HT_PHASOR response =
                        technicalIndicators.ht_phasor("DUMMY", Interval.WEEKLY, SeriesType.CLOSE);
